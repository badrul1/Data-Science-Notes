...
var l,
    ...
    valid = false,
    a = "",
    fwk = "https://platform.linkedin.com/js/framework?v=0.0.1191-RC8.60386-1429",
    xtnreg = /extensions=([^&]*)&?/,
...
if AUTH_USERSPACE
  ...
  */
    ...
    l.xd_html = "https://platform.linkedin.com/js/xdrpc.html?v=0.0.1191-RC8.60386-1429";
    l.xd_us_html = "https://platform.linkedin.com/js/xdrpc.html?v=0.0.1191-RC8.60386-1429";
    l.api_xd_html = "https://api.linkedin.com/uas/js/xdrpc.html?v=0.0.1191-RC8.60386-1429";
    ...
    l.userspace_renew = "https://www.linkedin.com/uas/js/authuserspace?v=0.0.1191-RC8.60386-1429&api_key={API_KEY}";
  ...
  */
    ...
    l.unsecure_xdswf = "https://platform.linkedin.com/js/easyXDM.swf?v=0.0.1191-RC8.60386-1429";
    l.secure_xdswf = "https://platform.linkedin.com/js/easyXDM.swf?v=0.0.1191-RC8.60386-1429";
...
if(this.width>0){a.width=this.width
}var d=this.userFields={};
var c=this.attributes;
for(var e in c){if(e.indexOf("field-")===0){d[c[e].toLowerCase()]=e.substring(6)
}}this.getProfileToElementMapping=function(k){var l=k.nodeName.toLowerCase();
if(!l||(l!=="input"&&l!=="select")){return false
}var j=k.getAttribute("type");
if(j&&j.length>0&&j.toLowerCase()==="hidden"){return false
}var m=k.getAttribute("data-in-profile");
if(m&&m.length>0){return m
}var n=k.getAttribute("placeholder");
if(n&&n.length>0){n=n.toLowerCase();
if(d[n]&&d[n].length>0){return d[n]
}}var i=k.getAttribute("name");
if(i&&i.length>0){i=i.toLowerCase();
if(d[i]&&d[i].length>0){return d[i]
}}if(k.id&&k.id.length>0){var o=k.id.toLowerCase();
if(d[o]&&d[o].length>0){return d[o]
}}if(i&&i.length>0){return i
}return false
};
this.setValue=function(n,o){if(n.nodeName==="SELECT"){var l=n.getElementsByTagName("option");
var k=o.toLowerCase();
try{for(var m=0;
m<l.length;
m++){if(l[m].value.toLowerCase()===k){l[m].selected=true
}}}catch(p){}}else{n.value=o
}if("createEvent" in document){var j=document.createEvent("HTMLEvents");
j.initEvent("change",false,true);
n.dispatchEvent(j)
}else{n.fireEvent("onchange")
}};
this.fireSubmitEvent=function(j){if(this.submitUrl){j.preventDefault();
var i=new Image();
var k=this.submitUrl.replace(/&amp;/g,"&");
k=k.replace(/__API_KEY__/g,encodeURIComponent(IN.ENV.js.apiKey));
k=k.replace(/__UNIQUE_ID__/g,encodeURIComponent(this.uniqueid));
var l=window.setTimeout(function(){f.submit();
i.onerror=i.onload=null
},1000);
i.onerror=i.onload=function(){f.submit();
window.clearTimeout(l)
};
i.src=k+"&rand="+(new Date()).getTime()
}};
var f;
var h=new IN.Objects.SmartWindow({mode:"embedded",disableRefresh:true,url:IN.ENV.widget.lilaform_url}).params(a);
var b=this,g=function(r){if(b.formid){f=document.getElementById(b.formid)||document.forms[b.formid]
}f=f||document.forms[0];
var n=[];
if(r.tracking&&r.tracking["onSubmit"]){this.submitUrl=r.tracking["onSubmit"]
}if(!r.data||!f){return
}var k=f.elements;
var p=k.length;
for(var l=0;
l<p;
l++){var o=b.getProfileToElementMapping(k[l]);
if(!o){continue
}o=o.toLowerCase();
var q=r.data[o];
if(q&&q.length>0){b.setValue(k[l],q);
n.push(o)
}}var m=new Image();
if(r.tracking&&r.tracking["onClick"]){var j=r.tracking["onClick"].replace(/&amp;/g,"&");
j=j.replace(/__FIELDS_FILLED__/g,encodeURIComponent(n));
j=j.replace(/__API_KEY__/g,encodeURIComponent(IN.ENV.js.apiKey));
j=j.replace(/__UNIQUE_ID__/g,encodeURIComponent(b.uniqueid));
m.src=j
}};
window.addEventListener("message",function(i){var j;
try{j=JSON.parse(i.data)
}catch(k){return
}if(!j.type||j.type!=="lilaform"||!j.result){return
}g(j.result)
},false);
h.success(g,this);
h.place(this.el())
